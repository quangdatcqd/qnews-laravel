    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <h2>{{$LT->Ten}}<small class="hidden-xs-down hidden-sm-down"></small></h2>
            </div><!-- end col -->
            <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                    <li class="breadcrumb-item"><a>{{$TL[0]->TenTL}}</a></li>
                    <li class="breadcrumb-item active"><a href="{{ action([TinController::class,'tinTrongLoai'], ['id'=>$LT->slugLT]) }}">{{$LT->Ten}}</a></li>
                </ol>
            </div><!-- end col -->                    
        </div><!-- end row -->
    </div><!-- end container -->
...
?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo $tinTL->links('vendor.pagination.bootstrap-4'); ?>
                    </div><!-- end col -->
                </div><!-- end row -->
            </div><!-- end col -->
