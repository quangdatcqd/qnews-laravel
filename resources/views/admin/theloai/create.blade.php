    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="card border-light shadow-sm components-section">
                <div class="card-body">
                    <form action="{{ url('/quan-tri/them-the-loai-moi') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="TenTL">Tên Thể Loại </label>
                                <input type="text" name="TenTL" value="{{ old('TenTL') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="ThuTu" value="{{ old('ThuTu') }}" class="form-control" id="ThuTu"
                            ...
                            <div class="row mx-4">
                                ...
                                <div class="form-check form-switch col-lg-3">
                                    <input class="form-check-input" @if (old('HienMenu')) checked @endif name="HienMenu" type="checkbox" id="HienMenu">
