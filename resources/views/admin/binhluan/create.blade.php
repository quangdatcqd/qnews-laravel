    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h4 class="font-weight-bold">Thêm Bình Luận</h4>
    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="card border-light shadow-sm components-section">
                <div class="card-body">
                    <form action="{{ url('/quan-tri/them-binh-luan-moi') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <!-- Form -->
                            ...
                            <div class="mb-4">
                                <label for="idTin">Bài Viết</label>
                                    ...
                                    <select class="form-select" id="idTin" name="idTin" aria-label="">
                                        ...
                                        @foreach ($tin as $tin )
                                            <option  value="{{$tin->idTin}}">{{$tin->TieuDe}}</option>
                                        @endforeach
                        ...
                        <div class="row">
                            <div class="mb-4">
                                ...
                                <textarea type="text"     cols="30" rows="10" name="NoiDung"  
